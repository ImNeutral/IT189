    ...
    <div class="col-lg-9 col-md-8 sub-content">
        ...
        <hr>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="faculty-id" name="faculty_id" placeholder="faculty_id" value="{{ $employee->faculty_id }}" required>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="full_name" name="full_name" placeholder="Last, First MI." value="{{ $employee->faculty_name }}" required>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="hea" name="hea" value="{{ $employee->highest_educational_attainment }}" placeholder="Highest Educational Attainment">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="specialization" name="specialization" value="{{ $employee->specialization }}" placeholder="Specialization">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="college" name="college" value="{{ $employee->college }}" placeholder="College">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="department" name="department" value="{{ $employee->department }}" placeholder="College Department">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="current-rank" name="current_rank" value="{{ $employee->current_rank }}" placeholder="Current Rank">
                </div>
            </div>
                ...
                <div class="col-sm-9">
                    <select class="form-control" name="for_rank" required>
                        ...
                        @foreach($rankCategories as $rankCategory)
                            <option value="{{ $rankCategory->id }}" {{ ($rankCategory->id == $employee->for_rank_category_id)? " SELECTED" : "" }}>{{ $rankCategory->rank_category }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
